 ...
 */
export const APP_NAME: string = 'buildinpublic';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Support your online builders';
 ...
 */
export const APP_TAGS: string[] = ['builder', 'growth', 'tip'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Support Builder';
